...
def parse_args():
    ...
    p.add_argument("--out_model", default="models/roberta_NM_Final")
    p.add_argument("--out_results", default="outputs/roberta_NM_Final")
...
def main():
    ...
    plt.title("Confusion Matrix - RoBERTA NM")
