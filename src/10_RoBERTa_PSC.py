...
def parse_args():
    ...
    p.add_argument("--modelo", default="models/modelo_final")
    p.add_argument("--out_model", default="models/roberta_psc_Final")
    p.add_argument("--out_results", default="outputs/roberta_psc_Final")
...
def main():
    ...
    plt.title("Confusion Matrix - ROBERTA + PSC")
