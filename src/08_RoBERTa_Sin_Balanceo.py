...
def parse_args():
    ...
    p.add_argument("--train", default="data/raw/train_final_SIN_EDA_Trans.csv")
    ...
    p.add_argument("--out_model", default="models/roberta_Final")
    p.add_argument("--out_results", default="outputs/roberta_Final")
